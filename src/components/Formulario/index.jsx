...
const Formulario = () => {
	...
	return (
		<>
			<form
				className="w-11/12 items-center h-full mx-auto py-10 px-5 mb-10 rounded-md"
			...
			>
				...
				<div className="mb-5">
					<input
						type="submit"
						className="bg-rosa text-blanco text-center w-1/4 py-1 px-3 rounded-3xl text-sm uppercase hover:bg-rosaFuerte"
						value={'Guardar'}
					></input>
				</div>
			</form>
